...
function filtroSelect() {
  ...
  if (select != null) {
    if (isBacia) {
      ...
      switch (select) {
        case "alphabet":
          bacias.sort((a, b) => a.name.localeCompare(b.name));
          break;
        case "size":
          bacias.sort((a, b) => b.tamanho_km2 - a.tamanho_km2);
          break;
        case "type":
          bacias.sort((a, b) =>
            a.tipo_de_fluido.localeCompare(b.tipo_de_fluido)
          );
          break;
      }
      ...
      switch (select) {
        case "alphabet":
          pocos.sort((a, b) => a.name.localeCompare(b.name));
          break;
        case "size":
          pocos.sort((a, b) => b.tamanho_km2 - a.tamanho_km2);
          break;
        case "type":
          pocos.sort((a, b) => a.tipo_fluidos.localeCompare(b.tipo_fluidos));
          break;
      }
